...
public class AnimatingColorChanger : MonoBehaviour
{
    ...
    public void AnimateAndColorChange()
    {
        ...
        for (int i = 0; i < transform.childCount; i++)
        {
            ...
            _propBlock.SetColor("_Color", Color.Lerp(StartColor, EndColor, Mathf.Sin((choosenChild.transform.position.y / verticalMultiplier))/2.0f+0.5f));
